...
const updateAdmins = () => {//by : ! Pirt YT#1739
  owner = db.get("admins")
  owner.unshift('870417868259459174') //ايديك
}
...
client.on("ready", () => {
  ...
  let textList = [`${prefix}stock` ,`${prefix}help`,"By : Pirt_YT"] 
